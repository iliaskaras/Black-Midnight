 ...
 * @author Ilias
 */
public class CreateStoreController_forTests {
    private StoreDAO_Test myDAO ;

    public CreateStoreController_forTests(StoreDAO_Test myDAO) {
      this.myDAO=myDAO;
    }
    
    public CreateStoreController_forTests(){
     ...
     */
       ...
       public boolean storeCreationForTest(String nameOfStore, int numberOfSeats,
           ...
           StoreDAO_Test stDAO = new StoreDAO_Test();
    ...
    public boolean checkIfStoreExistsForTest(String storeName, String storeAddress){
        StoreDAO_Test myStDao = new StoreDAO_Test();
