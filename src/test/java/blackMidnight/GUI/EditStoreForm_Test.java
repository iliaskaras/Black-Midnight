 ...
 * @author Ilias
 */
@GUITest public class EditStoreForm_Test {
    
    private FrameFixture window;
    
    public EditStoreForm_Test() {
    }
    ...
    public void setUp() throws Exception {
       ...
       window = new FrameFixture(new EditStoreForm_forTests());
       window.show();  
     }
...
//    }
    ...
    public void testFailedStoreCreationCheck()  {
        ...
        window.textBox("toOpenHoursTFld").setText("00:00"); 
        window.button("addStoreBtn").click();
        window.optionPane().requireInformationMessage().requireMessage("Store Update Failed\n");
    }
    
    @Test
    public void testStoreUpdatedSuccess()  {
        ...
        window.checkBox("mondayCBx").check();
        window.button("addStoreBtn").click();
        window.optionPane().requireInformationMessage().requireMessage("Store Updated Succesfully");
        window.optionPane().okButton().click();
    }
